...
<body>
	<div class="article-container tategaki">
		<div id="namecard">
			...
			<div id="self_intro">
				<p>シンガポールで働いでいるソフトウェアエンジニアです。<br>神道・言語・古典・沖縄学などに興味が有ります。</p>
				<p>大学で日本研究学科を主専攻として選びました。それを切っ掛けに、「古事記」を始め、「風土記」や「日本書紀」等、色々な古典を読み始めました。</p>
				<p>皮肉なものだけど、中国人としての私は、中学校から漢文が物凄く苦手でした。しかし、和本古典を読む時、漢文からの典故がよく見えます。時々漢文原文から典故の意味を調べる為、何時の間にか漢文に二股をかけました（笑）。</p>
